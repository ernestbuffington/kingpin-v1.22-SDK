...
void CL_RegisterTEntSounds (void)
{
	...
	//for (i = 0; i < 4; i++) {														// kingpin v1.21
	//	Com_sprintf(name, sizeof(name), "player/pl_alpha%i.wav", i + 1);			// kingpin v1.21
	//	clMedia.sfx_alpha_footsteps[i] = S_RegisterSound(name);						// kingpin v1.21
	//}																				// kingpin v1.21
	//for (i = 0; i < 4; i++) {														// kingpin v1.21
	//	Com_sprintf(name, sizeof(name), "player/pl_water%i.wav", i + 1);			// kingpin v1.21
	//	clMedia.sfx_water_footsteps[i] = S_RegisterSound(name);						// kingpin v1.21
	//}																				// kingpin v1.21
	//for (i = 0; i < 4; i++) {														// kingpin v1.21
	//	Com_sprintf(name, sizeof(name), "player/pl_concrete%i.wav", i + 1);			// kingpin v1.21
	//	clMedia.sfx_concrete_footsteps[i] = S_RegisterSound(name);					// kingpin v1.21
	//}																				// kingpin v1.21
	//for (i = 0; i < 4; i++) {														// kingpin v1.21
	//	Com_sprintf(name, sizeof(name), "player/pl_fabric%i.wav", i + 1);			// kingpin v1.21
	//	clMedia.sfx_fabric_footsteps[i] = S_RegisterSound(name);					// kingpin v1.21
	//}																				// kingpin v1.21
	//for (i = 0; i < 4; i++) {														// kingpin v1.21
	//	Com_sprintf(name, sizeof(name), "player/pl_metal_light%i.wav", i + 1);		// kingpin v1.21
	//	clMedia.sfx_metal_light_footsteps[i] = S_RegisterSound(name);				// kingpin v1.21
	//}
