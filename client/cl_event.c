...
void CL_FootSteps (entity_state_t *ent, qboolean loud)
{
	...
	case SURF_WOOD:
		...
		break;
	//case SURF_ALPHA:
	//	stepsound = clMedia.sfx_alpha_footsteps[r];
	//	break;
	//case SURF_WATER:
	//	stepsound = clMedia.sfx_water_footsteps[r];
	//	break;
	//case SURF_CONCRETE:
	//	stepsound = clMedia.sfx_concrete_footsteps[r];
	//	break;
	//case SURF_FABRIC:
	//	stepsound = clMedia.sfx_fabric_footsteps[r];
	//	break;
	//case SURF_METAL_L:
	//	stepsound = clMedia.sfx_metal_light_footsteps[r];
	//	break;
	case SURF_STANDARD:
