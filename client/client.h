...
//	struct sfx_s    *sfx_alpha_footsteps[4];       // kingpin v1.21
//	struct sfx_s    *sfx_water_footsteps[4];       // kingpin v1.21
//	struct sfx_s    *sfx_concrete_footsteps[4];    // kingpin v1.21
//	struct sfx_s    *sfx_fabric_footsteps[4];      // kingpin v1.21
//	struct sfx_s    *sfx_metal_light_footsteps[4]; // kingpin v1.21
