...
#define SAVEGAME_DLLNAME "Kingpin: Life Of Crime Multi Mod v2"
...
#ifdef KINGPIN_ENGINE_MOD		    // Knightmare- increase MAX_EDICTS
#define	MAX_EDICTS			8192	// must change protocol to increase more
#else
#define	MAX_EDICTS			2048	// was 1024 in standard Q2 moved to 2048 per Kingpin v1.21 must change protocol to increase more
#endif

#define	MAX_LIGHTSTYLES		256	    // I assume this must stay at 256 not sure

#ifdef KINGPIN_ENGINE_MOD		    // Knightmare- Ding-Dong, Index: Overflow is dead!
...
#define	MAX_SOUNDS			384	// In Q2 is it was 256 moved to 384 per Kingpin v1.21 so they cannot be blindly increased
#define	MAX_IMAGES			256
#endif

//Knightmare- hacked offsets for old demos
#define	OLD_MAX_MODELS		256
#define	OLD_MAX_SOUNDS		384 // was 256 fro Q2 moved to 384 per Kingpin v1.21
...
#define MAX_LIGHTFLARES		128 // This is not in Quake 2 and was moved here per Kingpin v1.21
#define MAX_JUNIOR_STRINGS	512	// This is not in Quake 2 and was moved here per Kingpin v1.21
...
extern vec3_t vec3_origin; // same in Kingpin v1.21
...
char* COM_Parse256(char **data_p); // Moved from Kingpin v1.21
...
qboolean kpInfo_Validate(char *s); // involves skins for kingpin
/*
==============================================================
...
//#define	LAST_VISIBLE_CONTENTS	64 Q2
// JOSEPH 
...
#define SURF_METAL		0x00000400	// metal floor - sorry laz kingpin did it 1st
...
#define SURF_TILE		0x00004000	// floor tiles - sorry laz kingpin did it 1st
#define SURF_GRASS      0x00008000  // grass
#define SURF_SNOW       0x00010000  // snow - sorry laz kingpin did it 1st
#define SURF_CARPET     0x00020000  // carpet
#define SURF_FORCE      0x00040000  // forcefield
#define SURF_GRAVEL     0x00080000  // gravel - sorry laz kingpin did it 1st
#define SURF_ICE		0x00100000  // ice
#define SURF_SAND		0x00200000  // sand
#define SURF_WOOD		0x00400000  // wood - sorry laz kingpin did it 1st
#define SURF_STANDARD	0x00800000  // standard	??

//#define SURF_ALPHA		0x01000000	   // wire fence effect flag
//#define SURF_WATER      0x02000000	   // fucking water
//#define SURF_CONCRETE	0x04000000   // concrete surface
//#define SURF_FABRIC		0x08000000   // fabric surface
      //#define SURF_GRAVEL		0x400000   // gravel surface
      //#define SURF_METAL		0x800000   // metal floor
//#define SURF_METAL_L	0x10000000  // metal floor lite
      //#define SURF_SNOW		0x2000000  // surface snow
      //#define SURF_TILE		0x4000000  // surface tile
      //#define SURF_WOOD		0x8000000  // surface wood
...
#define	BUTTON_USE			2
#define	BUTTON_ACTIVATE		4			// Joseph per Kingpin
#define BUTTON_ATTACK2      8           // 4 to 8
...
#define EF_FLASHLIGHT		0x00200000 // Kingpin v1.21
#define EF_GREENGIB			0x00200000 // ?? What the fuck did Kingpin do with this ?? It is not in Kingpin source!
...
#define EF_REFL				0x04000000 // Kingpin v1.21
#define	EF_FLAMETHROWER		0x08000000 // Kingpin v1.21
...
#define RF_REFL_MAP			8192    // kingpin v1.21  (1<<13)
#define	RF_FACING			16384	// kingpin v1.21  (1<<14)
#define RF_FACINGUP			32768	// kingpin v1.21  (1<<15)
// JOSEPH 21-JAN-99
#define	RF_DIMLIGHT		    (1<<16) // kingpin v1.21  allways draw dim light intensity
// END JOSEPH

#define RF_TRANS_ADDITIVE	65536
#define RF_MIRRORMODEL		131072
...
#define RF2_FLAMESHOOTER		1	  // kingpin v1.21
#define RF2_FLAMESHOOTER_MOD	2	  // kingpin v1.21
#define RF2_MODULUS_FRAME		4	  // kingpin v1.21 if the frame is higher than the max, just do a MODULUS on it
#define RF2_8					8	  // kingpin v1.21
#define RF2_16					16	  // kingpin v1.21
// END JOSEPH

#define RF2_ONLY_PARENTAL_LOCKED 32	  // kingpin v1.21	// Ridah, this entity is visible only to clients who have the parental lock ENABLED (ie. if a player is gibbed, the body remains in the game, but is only visible to client's who can't see the gibs, since they are parental locked)
#define RF2_SCALE50			     64	  // kingpin v1.21	// .5
#define	RF2_SCALE25			     128  // kingpin v1.21  // .25

#define RF2_MONEYBAG		     256  // kingpin v1.21 used for Teamplay, shows a moneybag on the player's back, automatically animated
#define	RF2_SURF_ALPHA		     512  // kingpin v1.21
#define	RF2_DIR_LIGHTS		     1024 // kingpin v1.21 Uses new directional lighting code
#define	RF2_FLAMETHROWER	     2048 // kingpin v1.21 client-side flamthrower effects (damage done in game code)
#define RF2_PASSALPHA		     4096 // kingpin v1.21
#define	RF2_NOSHADOW		     8192 // kingpin v1.21
#define	RF2_BEAM2			    16384 // kingpin v1.21
#define	RF2_PASSLIGHT		    32768 // kingpin v1.21

// player_state_t->refdef flags
#define	RDF_UNDERWATER		1		// kingpin v1.21 warp the screen as apropriate
#define RDF_NOWORLDMODEL	2		// kingpin v1.21 used for player configuration screen

#define	RDF_PAUSED			4		// kingpin v1.21 Ridah, so renderer knows if it's paused

// RAFAEL
#define	RDF_NOLERP			8		// kingpin v1.21
#define RDF_SKINPLUS		16		// kingpin v1.21
#define RDF_SKINPLUSPLUS	32		// kingpin v1.21

// JOSEPH 14-JAN-99
#define RDF_NOWORLDMODELALPHA 64	// kingpin v1.21 used for inventory screen

//#define	RF2_NOSHADOW		0x00000001		//no shadow.. Q2
...
#define	MZ_PISTOL			 19  // kingpin v1.21

#define MZ_BLACKJACK_SWING	 20  // kingpin v1.21
#define MZ_BLACKJACK_HIT	 21	 // kingpin v1.21

#define MZ_SPISTOL			 22	 // kingpin v1.21
#define MZ_PISTOL_DAMAGE_MOD 23	 // kingpin v1.21

// JOSEPH 19-JAN-99
#define MZ_CROWBAR_SWING	 24	 // kingpin v1.21
#define MZ_CROWBAR_HIT		 25	 // kingpin v1.21
// END JOSEPH

#define MZ_BARMACHINEGUN	 26  // kingpin v1.21
#define MZ_BARMACHINEGUN2	 27	 // kingpin v1.21
...
// JOSEPH 2-SEP-98
#define MZ3_LEADHIT_METAL				1    // kingpin v1.21

extern	vec3_t monster_flash_offset [];

// Ridah, Surface Sprite Effects			 // kingpin v1.21
#define	SFX_SPRITE_SURF_BLOOD1		0		 // kingpin v1.21
#define	SFX_SPRITE_SURF_BULLET1		1		 // kingpin v1.21
#define	SFX_SPRITE_SURF_RIPPLE		2		 // kingpin v1.21
#define SFX_SPRITE_SURF_BLOOD_POOL  5		 // kingpin v1.21
// need these for each SFX_SPRITE_SURF, so the engine knows what dimensions they are
#define	SFX_BLOOD_WIDTH		16				 // kingpin v1.21
#define	SFX_BLOOD_HEIGHT	16				 // kingpin v1.21
#define	SFX_BULLET_WIDTH	1				 // kingpin v1.21
#define	SFX_BULLET_HEIGHT	1				 // kingpin v1.21
#define	SFX_RIPPLE_WIDTH	8				 // kingpin v1.21
#define	SFX_RIPPLE_HEIGHT	8				 // kingpin v1.21
// SFX flags
#define	SFX_FLAG_GRAVITY		1		      // kingpin v1.21 velocity is effected by gravity
#define	SFX_FLAG_SURFACE_EFFECT	2		      // kingpin v1.21 this is a surface effect, therefore velocity is the surface normal, and sprite will use alpha = 1 for "fadein_time"
#define	SFX_FLAG_NO_FLIP		4		      // kingpin v1.21 this SFX won't have it's S coordinate randomly flipped
#define	SFX_FLAG_LIGHTFLARE		8		      // kingpin v1.21 no depth checking, align with view
#define	SFX_FLAG_DEPTHHACK		16		      // kingpin v1.21
#define	SFX_FLAG_UPRIGHT		32		      // kingpin v1.21 used for fire in barrel
#define SFX_FLAG_VEL_IS_ANGLES	64		      // kingpin v1.21
#define	SFX_FLAG_ADDITIVE_BLEND	128		      // kingpin v1.21
#define	SFX_FLAG_ALPHA_IS_FRAME	256		      // kingpin v1.21
#define	SFX_FLAG_VEL_IS_COLOR_MODULATION 512  // kingpin v1.21
#define	SFX_FLAG_CLOSE_CULL		         1024 // kingpin v1.21
#define	SFX_GRAVITY				        100.0 // kingpin v1.21 gravity value for all SFX effected by gravity
...
// Knightmare added
	...
	TE_GUNSHOT_VISIBLE,            //60 - kingpin v1.21
	TE_METAL_SPARKS,			   //61 - kingpin v1.21
	// JOSEPH 30-AUG-98
	TE_SFXFIRE,					   //62 - kingpin v1.21
	TE_SFXSMOKE,				   //63 - kingpin v1.21
	TE_SFXFIREGO,				   //64 - kingpin v1.21
	TE_SUN_FLARE,				   //65 - kingpin v1.21
	TE_GUN_FLARE,				   //66 - kingpin v1.21
	TE_SNOW,					   //67 - kingpin v1.21
	TE_RAIN,					   //68 - kingpin v1.21
	// END JOSEPH
	TE_LIGHT_FLARE,				   //69 - kingpin v1.21
	// Ridah, Surface Sprites
	// RAFAEL
	TE_BLOOD_DRIP,			       //70 - kingpin v1.21
	TE_BLOOD_SPLAT,			       //71 - kingpin v1.21
	TE_BLOOD_POOL,			       //72 - kingpin v1.21
	TE_SURFACE_SPRITE_ENTITY,      //73 - kingpin v1.21
	TE_BURN_TO_A_CRISP,		       //74 - kingpin v1.21
	// JOSEPH 18-FEB-99
	TE_CONCUSSION_EXPLOSION,       //75 - kingpin v1.21
	TE_CONCUSSION_EXPLOSION_WATER, //76 - kingpin v1.21
	TE_EXPLOSION1B,				   //77 - kingpin v1.21
	// END JOSEPH
	// JOSEPH 1-MAR-99
	TE_IMPACT,					   //78 - kingpin v1.21
	TE_EXPLOSION1C,				   //79 - kingpin v1.21
	// END JOSEPH
	// JOSEPH 19-FEB-99
	TE_SFXSTEAM,				   //80 - kingpin v1.21
	// END JOSEPH
	// JOSEPH 3-MAR-99
	TE_SFXSMOKE2,				   //81 - kingpin v1.21
	// END JOSEPH
	// JOSEPH 2-APR-99 
	TE_IMPACT_CONCUSSION,		   //82 - kingpin v1.21
	// END JOSEPH
	TE_ART_BURN,				   //83 - kingpin v1.21 used to mark surfaces by artists
	TE_FOG_BRUSH,				   //84 - kingpin v1.21
	TE_GIBS,					   //85 - kingpin v1.21
	TE_CONCUSSION_EXPLOSION_BIG,   //86 - kingpin v1.21
	// JOSEPH 9-APR-99
	TE_BARMACHINGUN,			   //87 - kingpin v1.21
	TE_SFXFIRET,				   //88 - kingpin v1.21
	// END JOSEPH
} temp_event_t;
...
// JOSEPH 17-MAY-99
#define SPLASH_SPARKS_P     7	  // kingpin v1.21
// END JOSEPH
...
#define	CHAN_BODY               4
#define CHAN_GIZMO				5
#define	CHAN_SPECIAL			6   // kingpin v1.21
// modifier flags
...
#define STAT_ZOOM                23
// kingpin v1.21 stats
#define STAT_CASH_PICKUP         24	 // kingpin v1.21
#define	STAT_ENDPIC				 25  // kingpin v1.21 previous STAT_TIMER_ICON 
#define STAT_CASH				 26	 // kingpin v1.21 
#define STAT_PICKUP_COUNT        27	 // kingpin v1.21 
#define STAT_CLIP				 28	 // kingpin v1.21 
#define STAT_CLIP_ICON			 29	 // kingpin v1.21 
#define STAT_HUD_INV			 30	 // kingpin v1.21 
// Following are duplicated for deathmatch, so beware if changing!
#define STAT_HUD_ENEMY_TALK      31	 // kingpin v1.21 
#define STAT_HUD_SELF_TALK       32	 // kingpin v1.21 
#define STAT_HUD_ENEMY_TALK_TIME 33	 // kingpin v1.21 
#define STAT_HUD_SELF_TALK_TIME  34	 // kingpin v1.21 
#define STAT_FORCE_HUD           35	 // kingpin v1.21 
#define STAT_HUD_HIRE1			 36	 // kingpin v1.21 
#define STAT_HUD_HIRE2			 37	 // kingpin v1.21 
#define STAT_HUD_HIRE1_CMD		 38	 // kingpin v1.21 
#define STAT_HUD_HIRE2_CMD		 39	 // kingpin v1.21 
// Ridah, duplicated these for use in teamplay, since they aren't used at all in multiplay
#define STAT_BAGCASH		     40  // kingpin v1.21 
#define STAT_DEPOSITED           41	 // kingpin v1.21 
#define STAT_TEAM1_SCORE		 42	 // kingpin v1.21 
#define STAT_TEAM2_SCORE		 43	 // kingpin v1.21 
#define STAT_TEAM1_FLASH		 44	 // kingpin v1.21 0 - no flash, 1 - green, 2 - red
#define STAT_TEAM2_FLASH		 45	 // kingpin v1.21 0 - no flash, 1 - green, 2 - red
#define STAT_POSITION		     46	 // kingpin v1.21 
#define STAT_PLAYERS		     47	 // kingpin v1.21 
#define STAT_KILLSTOGO		     48	 // kingpin v1.21 
#define STAT_HIDE_HUD            49	 // kingpin v1.21 
#define STAT_SWITCH_CAMERA       50	 // kingpin v1.21 
...
#ifdef KINGPIN_ENGINE_MOD // Knightmare increased
...
#define	DF_AUTO_JOIN_TEAM	0x00200000 // kingpin v1.21
...
#define CS_DENSITY			6  // kingpin v1.21
#define CS_FOGVAL			7  // kingpin v1.21
#define CS_DENSITY2			8  // kingpin v1.21
#define CS_FOGVAL2			9  // kingpin v1.21

#define CS_AIRACCEL			10 // air acceleration control

#define	CS_SERVER_VERSION	29 // so new clients can decide which version of download code to use

#define	CS_MAXCLIENTS		30 // max clients ??? This can't be accurate??
...
// Ridah, Lightflares kingpin v1.21
...
/* NOT SURE WHAT THIS WAS At ONE TIME??
typedef struct
{
	char	showflare;
	vec3_t	origin;
...
{
	EV_NONE,							      //0 q2
	EV_ITEM_RESPAWN,					      //1 q2
	EV_FOOTSTEP,						      //2 q2
	EV_FOOTSTEP0, // kingpin v1.21		      //3 kp
	EV_FOOTSTEP1, // kingpin v1.21		      //4 kp
	EV_FOOTSTEP2, // kingpin v1.21		      //5 kp
	EV_FOOTSTEP3, // kingpin v1.21		      //6 kp
	EV_FOOTSTEP4, // kingpin v1.21		      //7 kp
	EV_FOOTSTEP5, // kingpin v1.21		      //8 kp
	EV_FOOTSTEP6, // kingpin v1.21		      //9 kp
	EV_FOOTSTEP7, // kingpin v1.21		      //10 kp
	EV_FOOTSTEP8, // kingpin v1.21		      //11 kp
	EV_FALLSHORT,						      //12 q2
	EV_FALLSHORT0, // kingpin v1.21		      //13 kp
	EV_FALLSHORT1, // kingpin v1.21		      //14 kp
	EV_FALLSHORT2, // kingpin v1.21		      //15 kp
	EV_FALLSHORT3, // kingpin v1.21		      //16 kp
	EV_FALLSHORT4, // kingpin v1.21		      //17 kp
	EV_FALLSHORT5, // kingpin v1.21		      //18 kp
	EV_FALLSHORT6, // kingpin v1.21		      //19 kp
	EV_FALLSHORT7, // kingpin v1.21		      //20 kp
	EV_FALLSHORT8, // kingpin v1.21		      //21 kp
	EV_FALL,							      //22 q2
	EV_FALLFAR,							      //23 q2
	EV_PLAYER_TELEPORT,					      //24 q2
	EV_OTHER_TELEPORT,					      //25 q2
	EV_LOUDSTEP, //loud footstep from landing //26 Knightmare added
	EV_SLOSH, //Sloshing in ankle-deep water  //27 Knightmare added
	EV_WADE, //wading or treading water		  //28 Knightmare added
	EV_WADE_MUD, //wading in mud			  //29 Knightmare added
	EV_CLIMB_LADDER //climbing ladder		  //30 Knightmare added
	//end Knightmare
} entity_event_t;

// JOSEPH 18-FEB-99																											 // kingpin v1.21
typedef enum																												 // kingpin v1.21
{																															 // kingpin v1.21
	TT_NONE = 0,																											 // kingpin v1.21
	TT_POSITIVE,																											 // kingpin v1.21
	TT_FIGHT,																												 // kingpin v1.21
	TT_NEGATIVE,																											 // kingpin v1.21
	TT_QUESTION,																											 // kingpin v1.21
	TT_NEUTRAL,																												 // kingpin v1.21
	TT_NEWHUD,																												 // kingpin v1.21
	TT_NO,																													 // kingpin v1.21
	TT_YES,																													 // kingpin v1.21
	TT_COMMAND,																												 // kingpin v1.21
} talk_tone;																												 // kingpin v1.21
// END JOSEPH																												 // kingpin v1.21
																															 // kingpin v1.21
// Ridah, MDX kingpin v1.21																									 // kingpin v1.21
typedef struct																												 // kingpin v1.21
{																															 // kingpin v1.21
  vec3_t mins,maxs;																											 // kingpin v1.21
} object_bounds_t;																											 // kingpin v1.21
																															 // kingpin v1.21
#define	MAX_MODEL_PARTS			8	// must change network code to increase this (also savegame code)						 // kingpin v1.21
#define	MAX_MODELPART_OBJECTS	8	// absolutely do not change, bound by "invisible_objects" bit-flags						 // kingpin v1.21
																															 // kingpin v1.21
typedef struct model_part_s																									 // kingpin v1.21
{																															 // kingpin v1.21
	// Ridah, MDX, ENABLE the following line when .mdx system goes online													 // kingpin v1.21
	int		modelindex;					// leave as 0 if blank																 // kingpin v1.21
																															 // kingpin v1.21
//	int		invisible_objects;			// bit flags that define which sub-parts NOT to display when SET					 // kingpin v1.21
	byte	invisible_objects;			// bit flags that define which sub-parts NOT to display when SET					 // kingpin v1.21
	byte	skinnum[MAX_MODELPART_OBJECTS];																					 // kingpin v1.21
																															 // kingpin v1.21
	// server-only data used for collision detection, etc																	 // kingpin v1.21
	int		object_bounds[MAX_MODELPART_OBJECTS];	// read in and allocated immediately after setting the modelindex		 // kingpin v1.21
	char* objectbounds_filename;			// so we can restore the object bounds data when loading a savegame				 // kingpin v1.21
																															 // kingpin v1.21
	int     baseskin;																										 // kingpin v1.21
	byte	hitpoints[MAX_MODELPART_OBJECTS];																				 // kingpin v1.21
	byte	hit_scale[MAX_MODELPART_OBJECTS]; // 0-250																		 // kingpin v1.21
} model_part_t;																												 // kingpin v1.21
// done.																													 // kingpin v1.21
																															 // kingpin v1.21
// entity_state_t is the information conveyed from the server																 // kingpin v1.21
// in an update message about entities that the client will																	 // kingpin v1.21
// need to render in some way																								 // kingpin v1.21
																															 // kingpin v1.21
#define	MAX_MODEL_DIR_LIGHTS	3		// bound to 8 by network code														 // kingpin v1.21
																															 // kingpin v1.21
typedef struct																												 // kingpin v1.21
{																															 // kingpin v1.21
	int		light_indexes[MAX_MODEL_DIR_LIGHTS];	// so we can tell the client to use a certain 							 // kingpin v1.21
	                                                // light index, and it knows the details for that light					 // kingpin v1.21
																															 // kingpin v1.21
	vec3_t	light_vecs[MAX_MODEL_DIR_LIGHTS]; // static light directions that touch this model (dynamic are added in ref_gl) // kingpin v1.21
	vec3_t	light_colors[MAX_MODEL_DIR_LIGHTS];																				 // kingpin v1.21
	float	light_intensities[MAX_MODEL_DIR_LIGHTS];	// 0.0 -> 1.0														 // kingpin v1.21
	byte	light_styles[MAX_MODEL_DIR_LIGHTS];																				 // kingpin v1.21
	int		num_dir_lights;																									 // kingpin v1.21
																															 // kingpin v1.21
	// below this doesn't get sent to client (only used at server side)														 // kingpin v1.21
	vec3_t	light_orgs[MAX_MODEL_DIR_LIGHTS];																				 // kingpin v1.21
																															 // kingpin v1.21
} model_lighting_t;																											 // kingpin v1.21
																															 // kingpin v1.21
// Ridah, flamethrower																										 // kingpin v1.21
typedef struct flamejunc_s																									 // kingpin v1.21
{																															 // kingpin v1.21
	vec3_t	org, vel;																										 // kingpin v1.21
	float	start_width, end_width, start_height, end_height;																 // kingpin v1.21
	float	lifetime, fadein_time;																							 // kingpin v1.21
	float	start_alpha, end_alpha;																							 // kingpin v1.21
																															 // kingpin v1.21
	// current values																										 // kingpin v1.21
	float	aged, alpha;																									 // kingpin v1.21
	float	width, height;																									 // kingpin v1.21
																															 // kingpin v1.21
	vec3_t	unitvel;																										 // kingpin v1.21
	int		hit_wall;																										 // kingpin v1.21
																															 // kingpin v1.21
	struct flamejunc_s* next;																								 // kingpin v1.21
} flamejunc_t;																												 // kingpin v1.21
...
typedef struct entity_state_s
{
	...
	int		frame;
	int		skinnum;
	//int		effects; // was changed to unsigned int for quake 2 but was an int in kingpin v1.21
#ifdef NEW_ENTITY_STATE_MEMBERS // Knightmare- allow the server to set this
	float	alpha;	            // entity transparency  which was in kingpin v1.21
#endif
	...
	// Ridah, MDX, making way for .mdx system..	kingpin v1.21 from HERE DOWN
	int num_parts;
	...
	//float	alpha;			                // set in CL_AddPacketEntities() from entity_state->effects	already in quake 2
...
typedef struct
{
	...
	// RAFAEL Kingpin v1.21 from HERE DOWN
	// weapon mdx
	int num_parts;
	model_part_t model_parts[MAX_MODEL_PARTS];
