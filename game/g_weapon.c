...
void blaster_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	#ifdef KINGPIN_ENGINE_MOD // Knightmare- looks better than flechette
...
void fire_blaster (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, int effect, qboolean q2hyper, int color)
{
	edict_t	*bolt;
	trace_t	tr;
