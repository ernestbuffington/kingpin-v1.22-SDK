...
#define SVF_DAMAGEABLE			0x00000008  // Quake 2 Damageables I do not seee this even being used anywhere!
#define SVF_TRIGGER_CAMOWNER    0x00000010
#define SVF_MUD                 0x00000020
#define	SVF_GIB					0x00000040	//Knightmare- gib flag
																					   // TheGhost add 2/16/2021
#define	SVF_PROP                0x00000080 // treat as CONTENTS_PROP for collision
// edict->solid values
