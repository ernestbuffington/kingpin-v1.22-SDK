...
//#define DEG2RAD( a ) ( a * M_PI ) / 180.0F This is q_shared.h NOT SURE WHY?? probably a better place for it!
...
#if 0  // THIS IS IN cl_utils.c I think this will be needed to build server side code as a stand alone ?? The file it is in, definately is not in the server build files??
