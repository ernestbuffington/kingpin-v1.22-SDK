...
#define	GAMEVERSION	"Kingpin: Life Of Crime v1.22"
...
void fire_blaster (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int speed, int effect, qboolean q2hyper, int color);
