...
# ADD LINK32 libcmt.lib oldnames.lib kernel32.lib /nologo /subsystem:console /machine:I386 /nodefaultlib /out:"..\kmqbsp3.exe"
...
# ADD LINK32 /nologo /subsystem:console /debug /machine:I386 /out:"..\kmqbsp3.exe"
