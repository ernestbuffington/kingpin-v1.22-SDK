...
#ifdef USE_OUT_DIMENSIONS // outdimensions
...
typedef struct
{
	...
	int		flags;
	int		value;
	short	color[3];		// Knightmare- added for surface color support
} brush_texture_t;
...
typedef struct brush_s
{
	...
	qboolean	isTerrain; // Knightmare added
	qboolean	isGenSurf; // Knightmare added
	qboolean	optimizedDetail; // Knightmare added
} mapbrush_t;
...
extern	int		max_entities;	// Knightmare- adjustable entity limit
...
// Knightmare changed
int TexinfoForBrushTexture (plane_t *plane, brush_texture_t *bt, vec3_t origin, int contents, qboolean isTerrain);
