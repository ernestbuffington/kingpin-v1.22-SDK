...
#define CONSOLE_WINDOW_CLASS_NAME	"Kingpin Console"

#ifdef ERASER_COMPAT_BUILD
#ifdef NET_SERVER_BUILD
#define CONSOLE_WINDOW_NAME			"Kingpin Console (Eraser net server)"
#else // NET_SERVER_BUILD
#define CONSOLE_WINDOW_NAME			"Kingpin Console (Eraser Compatible)"
#endif // NET_SERVER_BUILD
#else // ERASER_COMPAT_BUILD
#ifdef NET_SERVER_BUILD
#define CONSOLE_WINDOW_NAME			"Kingpin Console (net server)"
#else
#define CONSOLE_WINDOW_NAME			"Kingpin Console"
#endif // NET_SERVER_BUILD
