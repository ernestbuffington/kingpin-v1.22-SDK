...
** VID_CreateWindow
*/
#define	WINDOW_CLASS_NAME	"Kingpin" // changed
#define	WINDOW_CLASS_NAME2	"Kingpin - The Reckoning" // changed
#define	WINDOW_CLASS_NAME3	"Kingpin - Ground Zero" // changed
