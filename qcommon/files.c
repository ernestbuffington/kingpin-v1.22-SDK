...
#define BASEDIRNAME				"main"		   /* changed to main for kingpin engine */
...
void FS_Startup (void)
{
	...
	if (stricmp(fs_gamedirvar->string, fs_currentGame))
	{
		...
		if (!stricmp(fs_gamedirvar->string, BASEDIRNAME))	// Don't add main again
